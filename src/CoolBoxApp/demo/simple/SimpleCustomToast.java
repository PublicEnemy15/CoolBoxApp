...
import SantaCruzDept.toast.ToastCustomPanel;
...
public class SimpleCustomToast extends ToastCustomPanel {
    ...
    private void init() {
        ...
        JLabel labelProfile = new JLabel(new AvatarIcon(getClass().getResource("/CoolBoxApp/demo/imagenes/profile_1.jpg"), 50, 50, 999));
        ...
        JButton buttonClose = new JButton(new FlatSVGIcon("CoolBoxApp/demo/icons/close.svg", 0.3f));
