...
import CoolBoxApp.demo.component.chart.*;
import CoolBoxApp.demo.component.chart.themes.ColorThemes;
import CoolBoxApp.demo.component.chart.themes.DefaultChartTheme;
import CoolBoxApp.demo.component.chart.utils.ToolBarCategoryOrientation;
import CoolBoxApp.demo.component.chart.utils.ToolBarTimeSeriesChartRenderer;
import CoolBoxApp.demo.component.dashboard.CardBox;
...
public class FormDashboard extends Form {
    ...
    private void loadData() {
        // load data card
        cardBox.setValueAt(0, "999", "+0 Nuevos registros", "+25%", true);
        cardBox.setValueAt(1, "$52,420.55", "Menos que el mes anterior", "-5%", false);
        cardBox.setValueAt(2, "$3,180.00", "Mas que el mes anterior", "+12%", true);
        cardBox.setValueAt(3, "$49,240.55", "Mas que el mes anterior", "+7%", true);
    ...
    private void createCard() {
        ...
        cardBox = new CardBox();
        cardBox.addCardItem(createIcon("CoolBoxApp/demo/icons/dashboard/customer.svg", DefaultChartTheme.getColor(0)), "No c que poner");
        cardBox.addCardItem(createIcon("CoolBoxApp/demo/icons/dashboard/income.svg", DefaultChartTheme.getColor(1)), "Ingresos Totales");
        cardBox.addCardItem(createIcon("CoolBoxApp/demo/icons/dashboard/expense.svg", DefaultChartTheme.getColor(2)), "Gastos Totales");
        cardBox.addCardItem(createIcon("CoolBoxApp/demo/icons/dashboard/profit.svg", DefaultChartTheme.getColor(3)), "Ultimo Ingreso");
        panel.add(cardBox);
