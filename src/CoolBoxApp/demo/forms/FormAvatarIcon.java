...
import CoolBoxApp.demo.component.AvatarBorderColorIcon;
...
public class FormAvatarIcon extends Form {
    ...
    private void setAvatar() {
        ...
        AvatarIcon avatarIcon = new AvatarIcon(getClass().getResource("/CoolBoxApp/demo/imagenes/profile_1.jpg"), width, height, value);
