package CoolBoxApp.demo.system;
...
import CoolBoxApp.demo.component.FormSearchButton;
import CoolBoxApp.demo.component.MemoryBar;
import CoolBoxApp.demo.component.RefreshLine;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JButton buttonDrawer = new JButton(new FlatSVGIcon("CoolBoxApp/demo/icons/menu.svg", 0.5f));
        buttonUndo = new JButton(new FlatSVGIcon("CoolBoxApp/demo/icons/undo.svg", 0.5f));
        buttonRedo = new JButton(new FlatSVGIcon("CoolBoxApp/demo/icons/redo.svg", 0.5f));
        buttonRefresh = new JButton(new FlatSVGIcon("CoolBoxApp/demo/icons/refresh.svg", 0.5f));
    ...
    private JPanel createFooter() {
        ...
        lbDemoVersion.setIcon(new SVGIconUIColor("CoolBoxApp/demo/icons/git.svg", 1f, "Label.disabledForeground"));
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbJava.setIcon(new SVGIconUIColor("CoolBoxApp/demo/icons/java.svg", 1f, "Label.disabledForeground"));
        panel.add(lbJava);
