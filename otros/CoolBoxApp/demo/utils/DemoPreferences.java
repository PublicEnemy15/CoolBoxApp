...
public class DemoPreferences {
    ...
    public static final String PREFERENCES_ROOT_PATH = "/CoolBoxApp-flatlaf-demo";
    ...
    public static final String THEME_UI_KEY = "__CoolBoxApp.flatlaf.demo.theme";
